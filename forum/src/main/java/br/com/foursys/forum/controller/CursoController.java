...
/**
 * Classe responsável por controlar os cursos do forum de duvidas
 * 
...
public class CursoController {
	...
	@GetMapping("/{id}")
	public DetalheDoCursoDto detalhar(@PathVariable Long id) {
		Curso curso = cursoRepository.getOne(id);
		return new DetalheDoCursoDto(curso);
	}
